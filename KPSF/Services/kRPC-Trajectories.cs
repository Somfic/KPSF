...
namespace KRPC.Client.Services.Trajectories
{
    ...
    public class Service
    {
        ...
        /// <summary>
        /// Returns the latitude and longitude of the impactposition or (-1, -1) if no active vessel or calculated trajectory.
        /// </summary>
        ...
        public double GetImpactHeightPosition()
        {
            ByteString _data = connection.Invoke("Trajectories", "GetImpactHeightPosition");
            return (double)global::KRPC.Client.Encoder.Decode(_data, typeof(double), connection);
        }
